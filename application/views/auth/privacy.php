    ...
    <section class="header">
        ...
        <section class="create">
            <div class="container-xxl">
                ...
                <h3>
                    Login<i class="fa fa-circle" aria-hidden="true"></i>
                </h3>
              
                <h6>Don't have a account? <a href="<?php echo base_url()?>signup">Sign Up </a></h6>
                <div class="row">
                    <div class="col-md-4">
                                ...
                                <div class="create-formss d-flex error">
                                    <div class="form-group create-form create-formint-1" style="width:100%;">
                                        ...
                                        <input type="email" class="form-control " name="email"
                                             id="email" placeholder="Enter Email & Username"  autocomplete="off"  >
                        ...
                        <div class="create-box-1">
                            <ul>
                               ...
                               <a href="<?php if(isset($googleLogin)) echo $googleLogin?>"><i class="fa fa-google-plus"
                                   aria-hidden="true"></i>Signin with Google</a>
                                </li>
                                <li id="fblogin">
                                    <a href="javascript:void(1)"><i class="fa fa-facebook" aria-hidden="true"></i>Signin
                                        with Facebook</a>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-apple" aria-hidden="true"></i>Signin with
                                        Apple Account</a>
                                </li>
                            </ul>
                        </div>
